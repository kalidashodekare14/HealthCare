...
const SuccessWork = () => {
  return (
    <div className='lg:mx-10'>
      <h1 className='text-3xl font-bold font-poppins'>Our Completed Works</h1>
      <div className='font-rubik m-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 my-10'>
        <div className='group'>
          ...
          <div className='relative z-20 w-80 p-3 bg-white group-hover:bg-[#307bc4] duration-500 shadow-xl -mt-10 hover: m-auto space-y-2'>
            ...
            <p className='text-[#000000bd] text-[15px] group-hover:text-white duration-500'>Advancing healthcare with cutting-edge solutions, compassionate care.</p>
          </div>
        </div>
        <div className='group'>
          ...
          <div className='relative z-20 w-80 p-3 bg-white group-hover:bg-[#307bc4] duration-500 shadow-xl -mt-10 m-auto space-y-2'>
            ...
            <p className='text-[#000000bd] text-[15px] group-hover:text-white duration-500'>Achieving success through innovative healthcare delivery, quality service.</p>
          </div>
        </div>
        <div className='group'>
          ...
          <div className='relative z-20 w-80 p-3 bg-white group-hover:bg-[#307bc4] duration-500 shadow-xl -mt-10 m-auto space-y-2'>
            <Link className='hover:text-[#307bc4]' href="#">
              <h1 className='text-xl font-bold group-hover:text-white duration-500'>Healthcare Success</h1>
            </Link>
            <p className='text-[#000000bd] text-[15px] group-hover:text-white duration-500'>Streamlining hospital operations and enhancing patient outcomes.</p>
          </div>
        </div>
      </div>
    </div>
