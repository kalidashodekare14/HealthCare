...
const MainDashboard = () => {
    ...
    const { data: dataCollection = [], iaLoading: loadingData } = useQuery({
        ...
        queryFn: async () => {
            const res = await axios.get(`${process.env.NEXT_SERVER_URL}/dashboard/api`)
            return res.data
        }
    })
    ...
    const { data: monthlyData = [] } = useQuery({
        ...
        queryFn: async () => {
            const res = await axios.get(`${process.env.NEXT_SERVER_URL}/dashboard/api/month-patient-doctor`)
            return res.data
        }
    })
    ...
    const { data: monthlyRevenue } = useQuery({
        ...
        queryFn: async () => {
            const res = await axios.get(`${process.env.NEXT_SERVER_URL}/dashboard/api/total-revenues`)
            return res.data
        }
    })
