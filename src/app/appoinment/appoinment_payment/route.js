...
export const POST = async (request) => {
    ...
    try {
        ...
        const initateData = {
            ...
            currency: "BDT",
            tran_id: tnxId,
            success_url: `${process.env.NEXT_BASE_URL}/appoinment/success-payment`,
            fail_url: `${process.env.NEXT_BASE_URL}/appoinment/payment-fail`,
            cancel_url: `${process.env.NEXT_BASE_URL}/appoinment/payment-cancel`,
